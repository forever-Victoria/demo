...
set(MSG_I_FLAGS "-Iabot_imu:/home/abot/demo/src/abot_base/abot_imu/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/abot/demo/src/abot_base/abot_imu/msg/RawImu.msg" NAME_WE)
add_custom_target(_abot_imu_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "abot_imu" "/home/abot/demo/src/abot_base/abot_imu/msg/RawImu.msg" "geometry_msgs/Vector3:std_msgs/Header"
)
...
_generate_msg_cpp(abot_imu
  "/home/abot/demo/src/abot_base/abot_imu/msg/RawImu.msg"
  "${MSG_I_FLAGS}"
